use crate::{NextSample, RawedioError, Sound, sounds::wrappers::SetSpeed, utils::tests::{ConstantValueSound, DEFAULT_SAMPLE_RATE, adapt_next_sample, adapt_next_samples_for}};
